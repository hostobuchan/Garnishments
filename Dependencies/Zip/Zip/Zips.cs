...
namespace Zip
{
    public class ZipArchive : IDisposable
    {
        ...
        public struct ZipFileInfo
        {
            ...
            {
                if (obj is ZipFileInfo) return ((ZipFileInfo)obj).external.Equals(this.external);
                else return false;
            }
            public override int GetHashCode()
            {
                return this.external.GetHashCode();
            }
            public static bool operator ==(ZipFileInfo z1, ZipFileInfo z2)
            {
                return z1.external == z2.external;
            }
            public static bool operator !=(ZipFileInfo z1, ZipFileInfo z2)
            {
                return z1.external != z2.external;
