...
{
    public partial class ParamObjControl<T> : ParamUserControl where T : ICriteriaParam
    {
        CObjListParam<T> Parameter { get; set; }
        ICodeListManager CodeListManager { get; set; }
        Type CodeListManagerType { get; set; }

        public ParamObjControl(CObjListParam<T> Parameter, Type CodeListManagerType)
        {
