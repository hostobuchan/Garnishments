...
{
    public partial class ParamBoolControl : ParamUserControl
    {
        CBoolParam Parameter { get; set; }
        ICodeListManager CodeListManager { get; set; }
        Type CodeListManagerType { get; set; }

        public ParamBoolControl(CBoolParam Parameter, Type CodeListManagerType)
        {
