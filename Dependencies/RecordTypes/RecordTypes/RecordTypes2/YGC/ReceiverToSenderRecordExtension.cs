...
{
    public class ReceiverToSenderRecordExtension : RecordTypes.YGC.Base.YGCReceiver2SenderRecord
    {
        ...
        public ReceiverToSenderRecordExtension(int RecordType) : base(RecordType) { }
        public ReceiverToSenderRecordExtension(string YGCRecord) : base(YGCRecord)
        {
        ...
        {
            return typeof(ReceiverToSenderRecordExtension);
        }
